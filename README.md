...
```
cd ~
curl -JOL "https://github.com/somegenericdev/hackernewsd/releases/download/v3.0.1/hackernewsd-v3.0.1-linux64.zip" && unzip hackernewsd-v*-linux64.zip && sudo mv hackernewsd /bin/hackernewsd
