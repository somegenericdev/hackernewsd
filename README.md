...
```
cd ~
curl -JOL "https://github.com/somegenericdev/hackernewsd/releases/download/v3.0.2/hackernewsd-v3.0.2-linux64.zip" && unzip hackernewsd-v*-linux64.zip && sudo mv hackernewsd /bin/hackernewsd
